...
- (void)onImageMessageClickWithAMid:(NSString * _Nonnull)aMid preView:(IMImageBrowserView * _Nonnull)preView selectImageInfo:(TMMImageSelectViewInfo * _Nonnull)selectImageInfo;
...
@property (nonatomic, copy) NSString * _Nonnull chatDetailNewMessageIcon;
@property (nonatomic, copy) NSString * _Nonnull chatDetailLastBrowseIcon;
@property (nonatomic, copy) NSString * _Nonnull chatSendIcon;
@property (nonatomic, copy) NSString * _Nonnull chatReadIcon;
@property (nonatomic, copy) NSString * _Nonnull chatMessagesSendingIcon;
@property (nonatomic, copy) NSString * _Nonnull chatMessagesSendFailIcon;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)syncOriginalDownloadStatusWithBrowserVo:(TMMImageBrowVo * _Nonnull)browserVo;
- (void)mediaLongPressWithBrowserVo:(TMMImageBrowVo * _Nonnull)browserVo;
- (void)mediaClickWithHidden:(BOOL)hidden browserVo:(TMMImageBrowVo * _Nonnull)browserVo;
...
+ (LottieAnimationView * _Nonnull)showEmptyView SWIFT_WARN_UNUSED_RESULT;
...
+ (NSArray<TMMChatMemberInfo *> * _Nonnull)getChatMemberinfosWithChatId:(NSString * _Nonnull)chatId uids:(NSArray<NSString *> * _Nonnull)uids dbBase:(IMDataBase * _Nonnull)dbBase SWIFT_WARN_UNUSED_RESULT;
+ (TMMChatMemberInfo * _Nonnull)getChatMemberInfoWithChatId:(NSString * _Nonnull)chatId uid:(NSString * _Nonnull)uid dbBase:(IMDataBase * _Nonnull)dbBase SWIFT_WARN_UNUSED_RESULT;
- (void)getChatMemberInfoWithChatId:(NSString * _Nonnull)chatId uids:(NSArray<NSString *> * _Nonnull)uids doneBlock:(void (^ _Nonnull)(NSArray<TMMChatMemberInfo *> * _Nonnull))doneBlock;
- (void)getChatMemberInfoWithChatId:(NSString * _Nonnull)chatId uid:(NSString * _Nonnull)uid doneBlock:(void (^ _Nonnull)(TMMChatMemberInfo * _Nonnull))doneBlock;
